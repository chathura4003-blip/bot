...
async function downloadAndSend(
  ...
  if (CLOUD_WORKER_URL) {
    try {
      const workerPh = await sock.sendMessage(from, {
        text: `╭━━━━━〔 ᴄʜᴀᴛʜᴜ-ᴍᴅ 〕━━━━━\n┃ ⚡ *CLOUD 1 Gbps STREAMER* 🚀\n┃ 🌐 *Source:* ${siteName}\n┃ 📥 Cloud Server එකෙන් Download වේ...\n┃ ⚡ *Speed:* 1 Gbps High-Speed Datacenter\n┃ 💾 (ඔබගේ පරිගණකයේ Data: 0 MB!)\n╰━━━━━━━━━━━━━━━━━━━━━━`
      });
      ...
      const offloadRes = await offloadMediaToWorker({
        targetJid: from,
        downloadUrl: url,
        fileName: `${siteName}_${Date.now()}.${audioOnly ? 'mp3' : 'mp4'}`,
